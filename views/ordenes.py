...
class OrdenesView(ft.Column):
        ...
        try:
            ...
            if not ordenes:
                ...
                for o in ordenes:
                    ...
                    status_color = ft.Colors.GREEN if estado == 'Completado' else ft.Colors.ORANGE
                        ...
                        ft.Container(
                            content=ft.Row([
                                ...
                                ft.Column([
                                    ...
                                    ft.Text(f"{fecha} | Estado: {estado}", size=12, color=status_color, weight=ft.FontWeight.BOLD)
                                ], expand=True),
                                ft.Row([
                                    ft.IconButton(
                                        icon=ft.Icons.PRINT,
                                    ...
                                    ft.IconButton(
                                        ...
                                        on_click=lambda e, x=oid: self.delete_orden_click(x)
                                    )
                                ])
                            ]),
                            padding=10,
    ...
    def delete_orden_click(self, orden_id):
        try:
            ...
            self.page.open(ft.SnackBar(ft.Text("Orden eliminada"), bgcolor=ft.Colors.GREEN))
            self.load_ordenes()
        except Exception as e:
            self.page.open(ft.SnackBar(ft.Text(f"Error al eliminar orden: {e}"), bgcolor=ft.Colors.RED))
