...
class ResultadosView(ft.Column):
    ...
    def save_all(self, e):
        ...
        try:
            ...
            self.page.open(ft.SnackBar(ft.Text("Resultados guardados y estado actualizado"), bgcolor=ft.Colors.GREEN))
            # Optional: Refresh sidebar list to show new status if changed?
            # self.load_ordenes()
