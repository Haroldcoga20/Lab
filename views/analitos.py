...
class AnalitosView(ft.Column):
    def __init__(self):
        ...
        # Form Controls (Removed Min/Max/Visual from UI as requested)
        ...
        # Hidden fields for logic continuity (optional, or just pass None in save)
        # We don't need controls for them if we don't show them.
        ...
        self.controls = [
            ...
            ft.Container(
                content=ft.Column([form_row1, form_row2, form_row4, actions_row]),
                padding=10,
    ...
    def edit_analito(self, analito: Analito):
        ...
        # Removed values setting for min/max/visual since controls are gone.
    ...
    def save_analito(self, e):
        try:
            data = {
                ...
                'valorRefMin': None, # Legacy
                'valorRefMax': None, # Legacy
                'referenciaVisual': None, # Legacy
