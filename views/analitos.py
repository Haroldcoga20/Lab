...
class RangosDialog:
    ...
    def delete_rango(self, rango_id):
        # Range deletion inside dialog - direct is usually fine for sub-items, but user asked "GLOBAL".
        # Let's keep it direct for sub-items to avoid nested dialog complexity unless critical.
        # But wait, user said "En views/analitos.py... Modifica la función de eliminar".
        # This usually refers to the main entity (Analito). I did that above.
        try:
