...
class AnalitosView(ft.UserControl):
    def __init__(self):
        super().__init__()
        self.analitos = []
    ...
    def save_analito(self, e):
        try:
            ...
            self.page.snack_bar = ft.SnackBar(ft.Text("Guardado correctamente"), bgcolor=ft.colors.GREEN)
    ...
    def open_rangos_dialog(self, e):
        ...
        self.page.dialog = self.rangos_dialog.dialog
        self.rangos_dialog.dialog.open = True
        self.page.update()
